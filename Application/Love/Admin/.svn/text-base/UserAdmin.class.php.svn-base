...
class UserAdmin extends CommonAdmin {
    ...
    public function index() {
        ...
        $attr['name'] = 'profile';
        $attr['title'] = '资料';
        $attr['href'] = U('Profile/Index',array('id'=>'__data_id__'));
        $attr['class'] = 'label label-primary';

        $attr1['name'] = 'attr';
        $attr1['title'] = '隐私';
        $attr1['href'] = U('Attr/Index',array('id'=>'__data_id__'));
        $attr1['class'] = 'label label-warning';

        $attr2['name'] = 'cond';
        $attr2['title'] = '择友';
        $attr2['href'] = U('Cond/index',array('id'=>'__data_id__'));
        $attr2['class'] = 'label label-danger';
